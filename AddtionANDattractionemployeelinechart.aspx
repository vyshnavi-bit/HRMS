<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeFile="AddtionANDattractionemployeelinechart.aspx.cs" Inherits="AddtionANDattractionemployeelinechart" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="content-header">
        <h1>
            AddtionANDattraction wise Chart<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Reports</a></li>
            <li><a href="#">AddtionANDattraction wise Chart</a></li>
        </ol>
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>AddtionANDattraction wise Performance Details
                </h3>
            </div>
            <div class="box-body">
                <div style="width: 100%;" align="center">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="button" id="submit" value="Generate" class="btn btn-primary" onclick="Addtionwiselinechartclick()" />
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    <script type="text/javascript">
        ...
        //            }
        //        }
        function Addtionwiselinechartclick() {
            var name = "";
            var ChartType = document.getElementById('ddlChartType').value;
            if (ChartType == "Location Wise") {
            ...
            var data = { 'op': 'Addtionwiselinechartclick', 'name': name, 'frommonth': frommonth, 'tomonth': tomonth, 'ChartType': ChartType, 'FormName': Linechartsalary };
            var s = function (msg) {
                if (msg) {
