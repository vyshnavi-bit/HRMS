<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="BranchwiseCasualReport.aspx.cs" Inherits="BranchwiseCasualReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
             Branchwise Casual Report <small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#">Branchwise Casual Statement</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i> Branchwise Casual  Details
                </h3>
            </div>
            <div class="box-body">
                    ...
                    <ContentTemplate>
                        <div>
                            <div align="center">
                                <table>
                                    <tr>
                                     <td id="tdpf" runat="server" visible="false">
                                            <asp:Label ID="Label3" runat="server" Text="Label">PF Mode</asp:Label>&nbsp;
                                            <asp:DropDownList ID="ddlpf" runat="server" CssClass="form-control">
                                            <asp:ListItem Value="00">Select Mode</asp:ListItem>
                                            <asp:ListItem Value="01">PF</asp:ListItem>
                                            <asp:ListItem Value="02">NON PF</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                         ...
                                         <td>
                                            <asp:Label ID="Label33" runat="server" Text="Label">EmployeeType</asp:Label>&nbsp;
                                        ...
                                        <div style="width: 100%;">
                                            ...
                                            <div align="center">
                                                ...
                                                <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                    Text=""></asp:Label>
                                                <br />
                                                 <asp:Label ID="lblHeading" runat="server" Font-Bold="true" Font-Size="14px" ForeColor="#0252aa"
                                                    Text=""></asp:Label>
                                                    <br />
                                            ...
                                            <div id="divnonpf" runat="server" Visible='false'>
                                                <asp:GridView ID="grdnonpf" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
                                                    GridLines="Both" Font-Bold="true" OnRowDataBound="grdnonpf_RowDataBound">
                                                    <EditRowStyle BackColor="#999999" />
                                                    <FooterStyle BackColor="Gray" Font-Bold="False" ForeColor="White" />
                                                    <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" ForeColor="Black" Font-Italic="False"
                                                        Font-Names="Raavi" Font-Size="Small" />
