<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Loan_report.aspx.cs" Inherits="Loan_report" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Loan Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Loan Details
                        </h3>
                            ...
                            <table>
                                ...
                                <td>
                                         ...
                                         <td>
                                            ...
                                            <asp:DropDownList ID="ddlyear" runat="server" CssClass="ddlclass" Width="100px">
                                            </asp:DropDownList>
                                        </td>
                                    <td>
