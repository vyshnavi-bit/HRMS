<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeFile="EmployeeCashReport.aspx.cs" Inherits="EmployeeCashReport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Cash Statement<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Cash Statement Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                            <table>
                                ...
                                <asp:Label ID="Label1" runat="server" Text="Label">Company</asp:Label>&nbsp;
                                  ...
                                  <asp:DropDownList ID="ddlbranches" runat="server" CssClass="ddlclass">
                                   ...
                                   <td>
                                            <asp:Label ID="Label5" runat="server" Text="Label">Year</asp:Label>&nbsp;
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div>
                                            <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
                                                ...
                                                <RowStyle BackColor="#ffffff" ForeColor="#333333" HorizontalAlign="Center" Height="44px" />
