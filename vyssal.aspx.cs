...
public partial class vyssal : System.Web.UI.Page
{
    SqlCommand cmd;
    string userid = "";
    DBManager vdm;
    ...
    protected void btn_Generate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddlemptype.SelectedItem.Text == "Staff" || ddlemptype.SelectedItem.Text == "Permanent")
            {
                ...
                if (dtsalary.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dtsalary.Rows)
                    {
                        ...
                        string empdept = dr["ftype"].ToString();
                        ...
                        if (empdept == prevdept)
                        {
                            ...
                            if (ftype == "1")
                            {
                                newrow["type"] = "Administration";
                            }
                            if (ftype == "2")
                            {
                                newrow["type"] = "Marketing";
                            }
                            if (ftype == "3")
                            {
                                newrow["type"] = "Plant";
            ...
            else if (ddlemptype.SelectedItem.Text == "Permaneneet")
            {
                Report.Columns.Add("SNO");
                Report.Columns.Add("Employee Code");
                Report.Columns.Add("Name");
    ...
    protected void grdReports_DataBinding(object sender, EventArgs e)
    {
        try
        {
            if (ddlemptype.SelectedItem.Text == "Staff" || ddlemptype.SelectedItem.Text == "Permanent")
            {
                GridViewGroup First = new GridViewGroup(grdReports, null, "type");
