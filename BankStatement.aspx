<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="BankStatement.aspx.cs" Inherits="BankStatement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
             Bank Statement <small>Preview</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i> Bank Statement Details
                </h3>
            </div>
            <div class="box-body">
                        ...
                        <div>
                            <div align="center">
                                <table>
                                    <tr>
                                    <td>
                                            <asp:Label ID="Label1" runat="server" Text="Label">Company</asp:Label>&nbsp;
                                        ...
                                        <td>
                                            ...
                                            <asp:ListItem>IFD Plant</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                           <td>
                                            <asp:Label ID="Label5" runat="server" Text="Label">Employee Type</asp:Label>&nbsp;
                                            <asp:DropDownList ID="ddlemptype" runat="server" CssClass="form-control">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label3" runat="server" Text="Label">Bank</asp:Label>&nbsp;
                                        ...
                                        <td style="padding-left: 1%;padding-top: 3%;">
                                        ...
                                        <div style="width: 100%;">
                                            ...
                                            <div align="center">
                                                ...
                                                <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                    Text=""></asp:Label>
                                                <br />
                                                 <asp:Label ID="lblHeading" runat="server" Font-Bold="true" Font-Size="15px" ForeColor="#0252aa"
                                                    Text=""></asp:Label>
                                                    <br />
                                            ...
                                            <table style="width: 80%">
                                                <tr>
                                                   <%-- <td>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lblFromDate"  Visible='false' runat="server" Text="" ForeColor="Red"></asp:Label>
                                                    </td>
                                                   <%-- <td>
                                                        To date:
                                                    </td>--%>
