...
public partial class TallyMarketingSalaryStatement : System.Web.UI.Page
{
    SqlCommand cmd;
    string userid = "";
    DBManager vdm;
    ...
    protected void btn_Generate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            lblHeading.Text = ddlbranches.SelectedItem.Text + " SAP MarketingSalary Statement" + ddlmonth.SelectedItem.Text + year;
            ...
            Session["filename"] = ddlbranches.SelectedItem.Text + " SAP MarketingSalary Statement " + ddlmonth.SelectedItem.Text + year;
            Session["title"] = ddlbranches.SelectedItem.Text + " SAP MarketingSalary Statement " + ddlmonth.SelectedItem.Text + year;
