<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="cmporgrpt.aspx.cs" Inherits="cmporgrpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Organization <small>Preview</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Organization Details
                </h3>
            </div>
            <div class="box-body">
                        ...
                        <div>
                            <div align="center">
                                <table>
                                    <tr>
                                     <td>
                                            ...
                                            <asp:DropDownList ID="ddltype" runat="server" CssClass="ddlclass" onselectedindexchanged="ddltype_SelectedIndexChanged" AutoPostBack="true">
                                            <asp:ListItem Value="00">Select Type</asp:ListItem>
                                            <asp:ListItem Value="01">Vyshnavi Group</asp:ListItem>
                                            <asp:ListItem Value="02">Company Wise</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="ddlcompany" runat="server" CssClass="ddlclass" Visible="false">
                                            </asp:DropDownList>
                                        </td>
                                ...
                                <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                                        ...
                                        <div style="width: 100%;">
                                            ...
                                            <div style="font-size: 12px !important;">
                                                <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
                                                    ...
                                                    <HeaderStyle BackColor="#f4f4f4" Font-Size="12px" Font-Bold="False" ForeColor="Black" Font-Italic="False"
                                                        Font-Names="Raavi"/>
                                    ...
                                    <br />
                                    <br />
                                    <asp:Button ID="btnsave" Visible="false" runat="Server" CssClass="btn btn-success" OnClick="btnlogssave_click" Text="Finalize Salary Statement" />
