<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeFile="SalaryAdvanceReport.aspx.cs" Inherits="SalaryAdvanceReport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Salary Advance Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Salary Advance Report</a></li>
                </ol>
            </section>
                    ...
                    <div class="box-body">
                        <div align="center">
                            <table style="width:100%;">
                                <tr>
                                <td>
                                        <asp:Label ID="Label" runat="server" Text="Label">Branch Name</asp:Label>&nbsp;
