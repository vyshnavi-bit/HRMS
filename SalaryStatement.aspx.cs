            ...
            if (ddlemptype.SelectedItem.Text == "Staff" || ddlemptype.SelectedItem.Text == "Retainers")
            {
                ...
                if (dtsalary.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dtsalary.Rows)
                    {
                        ...
                        //double otherallawance = Math.Round(thra - tt);
                        //if (otherallawance > 0)
                        //{
            ...
            else if (ddlemptype.SelectedItem.Text == "Permanent")
            {
                ...
                if (dtsalary.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dtsalary.Rows)
                    {
                        ...
                        //{
                        //    newrow["Variable Allowance"] = 0;
                        //    //tt = bs + conve + medical + washing;
                        //    //hra = Math.Round(thra - tt);
                        //    //totalearnings = Math.Round(hra + tt);
                        //}
                        if (hra > 0)
                        {
                        ...
                        if (pfeligible == "Yes")
                        {
                            ...
                            providentfund = Math.Round(providentfund, 0);
                            newrow["PF"] = Math.Round(providentfund, 0);
                            double employercontri = (totalearnings * 12) / 100;
                        ...
                        if (ddlbranch.SelectedItem.Value == "1043" || ddlbranch.SelectedItem.Value == "1055" || ddlbranch.SelectedItem.Value == "1049" || ddlbranch.SelectedItem.Value == "1048" || ddlbranch.SelectedItem.Value == "1047" || ddlbranch.SelectedItem.Value == "1070")
                        {
                            if (esieligible == "Yes")
                            {
                                if (totalearnings < 21001)
                                {
                                    ...
                                    esi = Math.Round(esi, 0);
                                    newrow["ESI"] = esi;
                                    double EMPLOYERESI = (totalearnings * 3.25) / 100;
                                    newrow["EESI"] = Math.Round(EMPLOYERESI, 0);
                                }
                            }
                            else
                            {
