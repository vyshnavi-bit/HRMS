<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeFile="compensationitemstatement.aspx.cs" Inherits="compensationitemstatement" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Compensation Item Statement <small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Compensation Item Statement </a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Compensation Item Statement Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlemp" runat="server" CssClass="form-control">
                                            <asp:ListItem Value="01">Employee No</asp:ListItem>
                                            <asp:ListItem Value="02">Name</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                            ...
                            <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        <div style="width: 13%; float: left; padding-bottom: 1%;">
