<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeFile="PayrollProcess.aspx.cs" Inherits="PayrollProcess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="content-header">
        <h1>
            Payroll Process<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <table id="tbl_leavemanagement" class="inputstable">
                <tr>
                    ...
                    <td style="height: 40px;">
                                            <input id="txtsupid" type="hidden" class="form-control"
                                                name="hiddenempid" />
                                 
                                </td>
                   <td style="height: 40px;">
                                            <input id="txtmonthsal" type="hidden" class="form-control"
                                                name="hiddenemployeid" />
    ...
    <div class="box box-info">
            ...
            <div class="box-body">
                    ...
                    <table align="center">
                        ...
                        <tr>
                            <td>
                                <input type="button" class="btn btn-primary" id="btn_save" value="Save" onclick="save_payrollSalary_click();" />
                                <input type="button" class="btn btn-danger" id="close_id" value="Close" onclick="canceldetails()"  />
                                <input type="button" id="Button1" class="btn btn-primary" onclick="javascript:CallPrint('divPrint');" value="Print" />
                            </td>
                        </tr>
            </table>
            <table class="tablecenter" width="98%">
                    ...
                    <table class="tablecenter">
                        ...
                        <tr>
                            ...
                            <td align="left" style="padding-left:18%;">
                               <label id="Label9" title="">Payslip for the month of</label><span id="spnmonthdetails"></span> <span id="spnyeardetails"></span> 
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td>
                    <table class="tablecenter" width="110%">
                        <tr>
                            <td align="left" style="padding-top: 5px; width: 110px;">
                            <label id="Label10" title="">Employee Code:</label>
                            </td>
                            ...
                            <label id="Label1" title="">Employee Name:</label>
                            </td>
                            <td align="left" style="padding-top: 5px; width: 110px;">
                                <span id="spnempnamedetails" style="font-weight:bold;"></span>
                            </td>
                            <td align="left" style="padding-top: 5px; width: 110px;">
                            <label id="Label7" title="">Bank Name:</label>
                            </td>
                        ...
                        <tr>
                            <td align="left" style="padding-top: 5px;">
                            <label id="Label2" title="">For Month:</label>
                            </td>
                            <td align="left" style="padding-top: 5px;">
                                <span id="spnformonthdetails" style="font-weight:bold;"></span>
                            </td>
                            <td align="left" style="padding-top: 5px;">
                            <label id="Label3" title="">No. of Days:</label>
                            </td>
                            <td align="left" style="padding-top: 5px;">
                                <span id="spnfornoofdaysdetails" style="font-weight:bold;"></span>
                            </td>
                            <td align="left" style="padding-top: 5px; width: 110px;">
                            <label id="Label12" title="">Bank Accoutno :</label>
                            </td>
                            <td align="left" style="padding-top: 5px;">
                        ...
                        <tr>
                            <td align="left" style="padding-top: 5px;">
                            <label id="Label4" title="">Days Paid:</label>
                            </td>
                            <td align="left" style="padding-top: 5px;">
                               <span id="spndayspaiddetails" style="font-weight:bold;"></span>
                            </td>
                            <td align="left" style="padding-top: 5px;">
                            <label id="Label5" title="">LOP:</label>
                            </td>
                            <td align="left" style="padding-top: 5px;">
                        ...
                        <tr style="display:none;">
                        <td align="left" style="padding-top: 5px;">
                            <label id="Label13" title="">OT:</label>
                            </td>
                            <td align="left" style="padding-top: 5px;">
                        ...
                        <tr>
                            <td colspan="6" >
                                <table width="100%" style="border: 1Px Solid Black;">
                                    ...
                                    <tr>
                                        <td valign="middle" align="left" style="border-right: 1px solid Black; height: 30px; text-align:center;">
                        ...
                        <tr>
                            <td colspan="6" align="center" style="padding-top: 15px">
                                <label>NOTE: This is computer generated payslip and needs no signature. If there is any discrepancy in your pay, you need to contact us within 3 days after payslip issue.</label>
                                <%--<asp:Label ID="lblNetPayAmount" runat="server" Font-Bold="true"></asp:Label>--%>
                            </td>
                        </tr>
                    </table>
