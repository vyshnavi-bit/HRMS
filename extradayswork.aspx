<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="extradayswork.aspx.cs" Inherits="extradayswork" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Extra Days Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Extra Days</a></li>
                </ol>
            </section>
            <section class="content" style="overflow: initial !important;">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Extra Days Details
                        </h3>
                    ...
                    <div class="box-body">
                        <div align="center">
                            <table>
                                ...
                                <td>
                                            <asp:Label ID="Label4" runat="server" Text="Label">EmployeeType</asp:Label>&nbsp;
