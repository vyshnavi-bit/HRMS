<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="CanteenDeductionImport.aspx.cs" Inherits="CanteenDeductionImport" %>
...
<asp:UpdateProgress ID="updateProgress1" runat="server">
    ...
    <div>
        <section class="content-header">
            <h1>
               Canteen Deduction Import<small>Preview</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                <li><a href="#">Canteen Deduction Import</a></li>
            </ol>
