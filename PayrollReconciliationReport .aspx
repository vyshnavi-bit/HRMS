<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="PayrollReconciliationReport .aspx.cs" Inherits="PayrollReconciliationReport_" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Payroll Reconciliation Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Payroll Reconciliation Details
                        </h3>
                            ...
                            <table>
                                ...
                                <td>
                                 ...
                                 <td>
                                            ...
                                            <asp:ListItem Value="01">Jan 2016</asp:ListItem>
                                            <asp:ListItem Value="02">Feb 2016</asp:ListItem>
                                            <asp:ListItem Value="03">Mar 2016</asp:ListItem>
                                            <asp:ListItem Value="04">Aprl 2016</asp:ListItem>
                                            <asp:ListItem Value="05">May 2016</asp:ListItem>
                                            <asp:ListItem Value="06">Jun 2016</asp:ListItem>
                                            <asp:ListItem Value="07">Jul 2016</asp:ListItem>
                                            <asp:ListItem Value="08">Aug 2016</asp:ListItem>
                                            <asp:ListItem Value="09">Sep 2016</asp:ListItem>
                                            <asp:ListItem Value="10">Oct 2016</asp:ListItem>
                                            <asp:ListItem Value="11">Nov 2016</asp:ListItem>
                                            <asp:ListItem Value="12">Dec 2016</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                        TO
                                        ...
                                        <div align="center">
                                            ...
                                            <br />
                                             <asp:Label ID="lblHeading" runat="server" Font-Bold="true" Font-Size="18px" ForeColor="#0252aa"
                                                    Text=""></asp:Label>
                                                    <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Salary
                                             Advance Register</span><br />
                                        </div>
