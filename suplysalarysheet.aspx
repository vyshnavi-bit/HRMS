<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="suplysalarysheet.aspx.cs" Inherits="suplysalarysheet" %>
                        ...
                        <div>
                            <div align="center">
                                ...
                                <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                                    ...
                                    <br />
                                    <br />
                                    <asp:Button ID="btnsave" runat="Server" CssClass="btn btn-success" OnClick="btnlogssave_click" Text="Finalize Salary Statement" Visible="false" />
