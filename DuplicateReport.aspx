<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="DuplicateReport.aspx.cs" Inherits="Duplicate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Duplicate Report <small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#">Duplicate Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Duplicate Report Details
                </h3>
            </div>
            <div class="box-body">
                                    ...
                                    <%-- <td>
                                        ...
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ddlbranch" runat="server" CssClass="form-control">
                                             <asp:ListItem Value="Bank Account Number">Bank Account Number</asp:ListItem>
                                            <asp:ListItem Value="ESI Number">ESI Number</asp:ListItem>
                                            <asp:ListItem Value="PAN Number">PAN Number</asp:ListItem>
                                             <asp:ListItem Value="PF Number<">PF Number</asp:ListItem>
                                            <asp:ListItem Value="UAN Number">UAN Number</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                         <%--<td>
