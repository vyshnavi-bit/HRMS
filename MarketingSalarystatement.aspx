<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="MarketingSalarystatement.aspx.cs" Inherits="MarketingSalarystatement" %>
...
<asp:UpdateProgress ID="updateProgress1" runat="server">
    ...
    <section class="content-header">
        <h1>
            MarketingSalary Statement <small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#">MarketingSalary Statement</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>MarketingSalary Statement Details
                </h3>
            </div>
            <div class="box-body">
