<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Canteen_deduction_report.aspx.cs" Inherits="Canteen_deduction_report" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Canteen Deduction Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Canteen Deduction Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Canteen Deduction Details
                        </h3>
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <br />
                                              <asp:Label ID="lblHeading" runat="server" Font-Bold="true" Font-Size="18px" ForeColor="#0252aa"
                                                    Text=""></asp:Label>
                                                    <br />
                                           <%-- <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Canteen Deduction Report</span><br />--%>
                                        </div>
                                        <table style="width: 80%">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="lblFromDate" runat="server" ForeColor="Red" style="display:none"></asp:Label>
                                                </td>
                                               <%-- <td>
                                                    To date:
                                                </td>--%>
