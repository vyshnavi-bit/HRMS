<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="PFWagelimitincreaseReport.aspx.cs" Inherits="PFWagelimitincreaseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
             PF Wage limitincrease Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#"> PFWage limitincrease Report </a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i> PF Wage limitincrease Details
                </h3>
            </div>
            <div class="box-body">
                                    ...
                                    <tr>
                                        <td>
                                         ...
                                         <td>
                                            ...
                                            <asp:DropDownList ID="ddlyear" runat="server" CssClass="form-control" Width="75px">
                                            </asp:DropDownList>
                                        </td>
                                         <td>
                                            <asp:Label ID="Label2" runat="server" Text="Label">From Month</asp:Label>&nbsp;
                                         ...
                                         <td>
                                            <asp:Label ID="Label3" runat="server" Text="Label">To Month</asp:Label>&nbsp;
                                        ...
                                        <div style="width: 100%;">
                                            ...
                                            <table style="width: 80%">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lblFromDate1" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                            <div >
                                                <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
                                                    GridLines="Both" Font-Bold="true" OnRowCreated="grdReports_RowCreated" OnRowDataBound="grdReports_RowDataBound">
