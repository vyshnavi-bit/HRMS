<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChartDashBoard.aspx.cs" Inherits="ChartDashBoard" %>
...
//        }
        ...
        function gsvds_cc_branch_details(msg) {
            for (var i = 0; i < msg.length; i++) {
                ...
                if (branchname == "Arani Cc") {
                    ...
                    document.getElementById('spn_arani_bid').innerHTML = branchid;
                }
                if (branchname == "Walaja ") {
                    ...
                    document.getElementById('spn_walaja_bid').innerHTML = branchid;
                }
                if (branchname == "Kaveripatnam") {
                    ...
                    document.getElementById('spn_kpm_bid').innerHTML = branchid;
                }
                if (branchname == "Rc Puram") {
                    ...
                    document.getElementById('spn_rc_bid').innerHTML = branchid;
                }
                if (branchname == "Tarigonda ") {
                    ...
                    document.getElementById('spn_tari_bid').innerHTML = branchid;
                }
                if (branchname == "Kaligiri") {
                    ...
                    document.getElementById('spn_Kaligiri_bid').innerHTML = branchid;
                }
                if (branchname == "RMRD Kuppam") {
                    ...
                    document.getElementById('spn_rmrd_bid').innerHTML = branchid;
                }
            }
        }
        ...
        function gsvds_plant_branch_details(msg) {
            for (var i = 0; i < msg.length; i++) {
                ...
                if (branchname == "Punabaka") {
                    ...
                    document.getElementById('spn_punabaka_bid').innerHTML = branchid;
                }
                if (branchname == "Kuppam") {
                    ...
                    document.getElementById('spn_kuppam_bid').innerHTML = branchid;
                }
            }
        }
        function get_svdssales_report() {
            ...
            var data = { 'op': 'get_gosvd_deptwise_report', 'month': month, 'year': year, 'cmpid': companyid, 'btype': btype };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
        ...
        function gsvds_sales_branch_details(msg) {
            for (var i = 0; i < msg.length; i++) {
                ...
                if (branchname == "Chennai ") {
                    ...
                    document.getElementById('spn_chn_bid').innerHTML = branchid;
                }
                if (branchname == "Bangalore") {

                    document.getElementById('spn_bang_totsal').innerHTML = totalgross;
                    var percentage = parseFloat(totsal).toFixed(2) + '%'
                    document.getElementById('spn_bang_Pers').innerHTML = percentage;
                    document.getElementById('spn_bang_bid').innerHTML = branchid;
                }
                if (branchname == "Kanchipuram ") {
                    ...
                    document.getElementById('spn_kanchi_bid').innerHTML = branchid;
                }
                if (branchname == "Nellore ") {
                    ...
                    document.getElementById('spn_nlr_bid').innerHTML = branchid;
                }
                if (branchname == "Madanapalli") {

                    document.getElementById('spn_mdnpl_totsal').innerHTML = totalgross;
                    var percentage = parseFloat(totsal).toFixed(2) + '%'
                    document.getElementById('spn_mdnpl_Pers').innerHTML = percentage;
                    document.getElementById('spn_mdnpl_bid').innerHTML = branchid;
                }
                if (branchname == "Tirupathi") {
                    ...
                    document.getElementById('spn_tpt_bid').innerHTML = branchid;
                }
                if (branchname == "Chennai Corporate Office") {

                    document.getElementById('spn_cco_totsal').innerHTML = totalgross;
                    var percentage = parseFloat(totsal).toFixed(2) + '%'
                    document.getElementById('spn_cco_Pers').innerHTML = percentage;
                    document.getElementById('spn_cco_bid').innerHTML = branchid;
                }
                if (branchname == "Skht Parlore") {
                    ...
                    document.getElementById('spn_skht_bid').innerHTML = branchid;
                }
                if (branchname == "Madanapalli Parlor") {

                    document.getElementById('spn_mdnplparl_totsal').innerHTML = totalgross;
                    var percentage = parseFloat(totsal).toFixed(2) + '%'
                    document.getElementById('spnmdnplparl_Pers').innerHTML = percentage;
                    document.getElementById('spn_mdnplparl_bid').innerHTML = branchid;
                }
            }
        }
        ...
        function gsvd_cc_branch_details(msg) {
            for (var i = 0; i < msg.length; i++) {
                ...
                if (branchname == "Kavali Office") {
                    ...
                    document.getElementById('spn_kvl_totsal').innerHTML = totalgross;
                    var percentage = parseFloat(totsal).toFixed(2) + '%'
                    document.getElementById('spn_kvl_Pers').innerHTML = percentage;
                    document.getElementById('spn_kvl_bid').innerHTML = branchid;
                }
                if (branchname == "Kondepi") {

                    document.getElementById('spn_kondepi_totsal').innerHTML = totalgross;
                    var percentage = parseFloat(totsal).toFixed(2) + '%'
                    document.getElementById('spn_Kondepi_Pers').innerHTML = percentage;
                    document.getElementById('spn_kondepi_bid').innerHTML = branchid;
                }
                if (branchname == "Kavali Plant") {

                    document.getElementById('spn_kvlp_totsal').innerHTML = totalgross;
                    var percentage = parseFloat(totsal).toFixed(2) + '%'
                    document.getElementById('spn_kvlp_Pers').innerHTML = percentage;
                    document.getElementById('spn_kvlp_bid').innerHTML = branchid;
                }
                if (branchname == "Gudluru") {

                    document.getElementById('spn_gudluru_totsal').innerHTML = totalgross;
                    var percentage = parseFloat(totsal).toFixed(2) + '%'
                    document.getElementById('spn_gudluru_Pers').innerHTML = percentage;
                    document.getElementById('spn_gudluru_bid').innerHTML = branchid;
                }
                if (branchname == "Gudipallipadu") {

                    document.getElementById('spn_gdpl_totsal').innerHTML = totalgross;
                    var percentage = parseFloat(totsal).toFixed(2) + '%'
                    document.getElementById('spn_gdpl_Pers').innerHTML = percentage;
                    document.getElementById('spn_gdpl_bid').innerHTML = branchid;
                }
                if (branchname == "C.S.Puram") {

                    document.getElementById('spn_cs_totsal').innerHTML = totalgross;
                    var percentage = parseFloat(totsal).toFixed(2) + '%'
                    document.getElementById('spn_cs_Pers').innerHTML = percentage;
                    document.getElementById('spn_cs_bid').innerHTML = branchid;
                }
            }
        }
        ...
        function rmr_branch_details(msg) {
            for (var i = 0; i < msg.length; i++) {
                ...
                if (branchname == "Ramdev") {
                    ...
                    document.getElementById('spn_rmrde_bid').innerHTML = branchid;
                }
            }
        }

        //-----------------depwise under svds cc------------//

        function get_aranibtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_arani_bid').innerHTML;
            var btype = "CC";
            var companycode = "1";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
                        get_arani_dept(msg);
        ...
        function get_arani_dept(msg) {
            var results = '<div class="k-top"><span class="k-in"><div class="k-top">';
            for (var i = 0; i < msg.length; i++) {
                results += '<tr><td></td>';
                results += '<th  class="1"><span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;background: aliceblue;"><span class="k-sprite folder"></span>' + msg[i].deptname + '</th>';
                ...
                results += '<th  class="2">&nbsp<span id="Span2" style="background-color: rgb(68, 128, 226);color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;height: 26px; line-height: 21px;">' + parseFloat(msg[i].totpercentage).toFixed(2) + "%" + '</span></span></span></th>';
                results += '</tr>';
                results += '<br/>';
            }
        ...
        function get_walajabtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_walaja_bid').innerHTML;
            var btype = "CC";
            var companycode = "1";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_walaja_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_walajadept").html(results);
        }
        function get_kpmbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_kpm_bid').innerHTML;
            var btype = "CC";
            var companycode = "1";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_kpm_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_kpmdept").html(results);
        }
        function get_rcbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_rc_bid').innerHTML;
            var btype = "CC";
            var companycode = "1";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_rc_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_rcdept").html(results);
        }
        function get_taribtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_tari_bid').innerHTML;
            var btype = "CC";
            var companycode = "1";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_tari_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_taridept").html(results);
        }
        function get_Kaligiribtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_Kaligiri_bid').innerHTML;
            var btype = "CC";
            var companycode = "1";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_Kaligiri_dept(msg) {
            var results = '<div class="k-top"><span class="k-in"><div class="k-top">';
            for (var i = 0; i < msg.length; i++) {
                results += '<tr><td></td>';
                results += '<th  class="1"><span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;background: aliceblue;"><span class="k-sprite folder"></span>' + msg[i].deptname + '</th>';
            ...
            results += '</div></span></div>';
            $("#div_Kaligiridept").html(results);
        }
        function get_rmrdbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_rmrd_bid').innerHTML;
            var btype = "CC";
            var companycode = "1";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_rmrd_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_rmrddept").html(results);
        }
        //-----------------depwise under svds plant------------//
        function get_punabakabtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_punabaka_bid').innerHTML;
            var btype = "Plant";
            var companycode = "1";
            var data = { 'op': 'get_svdsPlant_deptwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
                        get_punabaka_dept(msg);
                    }
                }
                else {
                }
        ...
        function get_punabaka_dept(msg) {
            var results = '<div class="k-top"><span class="k-in"><div class="k-top">';
            for (var i = 0; i < msg.length; i++) {
                results += '<tr><td></td>';
                results += '<th  class="1"><span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;background: aliceblue;"><span class="k-sprite folder"></span>' + msg[i].deptname + '</th>';
            ...
            results += '</div></span></div>';
            $("#div_punabakadept").html(results);
        }
        function get_kuppambtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_kuppam_bid').innerHTML;
            var btype = "Plant";
            var companycode = "1";
            var data = { 'op': 'get_svdsPlant_deptwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_kuppam_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_kuppamdept").html(results);
        }
        //----------depwise under svds sales-------------//
        function get_chennaibtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_chn_bid').innerHTML;
            var btype = "SalesOffice";
            var companycode = "1";
            var data = { 'op': 'get_gosvd_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
                        get_chennai_dept(msg);
                    }
                }
                else {
                }
        ...
        function get_chennai_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_chennaidept").html(results);
        }
        function get_bangbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_bang_bid').innerHTML;
            var btype = "SalesOffice";
            var companycode = "1";
            var data = { 'op': 'get_gosvd_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_bang_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_bangdept").html(results);
        }
        function get_kanchibtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_kanchi_bid').innerHTML;
            var btype = "SalesOffice";
            var companycode = "1";
            var data = { 'op': 'get_gosvd_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_kanchi_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_kanchidept").html(results);
        }
        function get_nlrbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_nlr_bid').innerHTML;
            var btype = "SalesOffice";
            var companycode = "1";
            var data = { 'op': 'get_gosvd_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_nlr_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_nlrdept").html(results);
        }
        function get_mdnplbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_mdnpl_bid').innerHTML;
            var btype = "SalesOffice";
            var companycode = "1";
            var data = { 'op': 'get_gosvd_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_mdnpl_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_mdnpldept").html(results);
        }
        function get_tptbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_tpt_bid').innerHTML;
            var btype = "SalesOffice";
            var companycode = "1";
            var data = { 'op': 'get_gosvd_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_tpt_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_tptdept").html(results);
        }
        function get_ccobtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_cco_bid').innerHTML;
            var btype = "SalesOffice";
            var companycode = "1";
            var data = { 'op': 'get_gosvd_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_cco_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_ccodept").html(results);
        }
        function get_skhtbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_skht_bid').innerHTML;
            var btype = "SalesOffice";
            var companycode = "1";
            var data = { 'op': 'get_gosvd_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_skht_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_skhtdept").html(results);
        }
        function get_mdnplparlbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_mdnplparl_bid').innerHTML;
            var btype = "SalesOffice";
            var companycode = "1";
            var data = { 'op': 'get_gosvd_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_mdnplparl_dept(msg) {
            var results = '<div class="k-top"><span class="k-in"><div class="k-top">';
            for (var i = 0; i < msg.length; i++) {
                results += '<tr><td></td>';
                results += '<th  class="1"><span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;background: aliceblue;"><span class="k-sprite folder"></span>' + msg[i].deptname + '</th>';
            ...
            results += '</div></span></div>';
            $("#div_mdnplparldept").html(results);
        }

        //----------depwise under svd cc-------------//     
        function get_kvlbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_kvl_bid').innerHTML;
            var btype = "CC";
            var companycode = "2";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_kvl_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_kvldept").html(results);
        }
        function get_kondepibtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_kondepi_bid').innerHTML;
            var btype = "CC";
            var companycode = "2";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_kondepi_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_kondepidept").html(results);
        }

        function get_kvlpbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_kvlp_bid').innerHTML;
            var btype = "CC";
            var companycode = "2";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_kvlp_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_kvlpdept").html(results);
        }

        function get_gudlurubtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_gudluru_bid').innerHTML;
            var btype = "CC";
            var companycode = "2";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_gudluru_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_gudlurudept").html(results);
        }

        function get_gdplbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_gdpl_bid').innerHTML;
            var btype = "CC";
            var companycode = "2";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_gdpl_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_gdpldept").html(results);
        }

        function get_csbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_cs_bid').innerHTML;
            var btype = "CC";
            var companycode = "2";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
        ...
        function get_cs_dept(msg) {
            ...
            results += '</div></span></div>';
            $("#div_csdept").html(results);
        }
        //----------depwise under Ramdev -------------//     
        function get_ramdevbtype_report() {
            var month = document.getElementById('mnt').value;
            var year = document.getElementById('year').value;
            var branchid = document.getElementById('spn_rmrde_bid').innerHTML;
            var btype = "Plant";
            var companycode = "4";
            var data = { 'op': 'get_svdcc_dephwise_report', 'companycode': companycode, 'branchid': branchid, 'btype': btype, 'month': month, 'year': year };
            var s = function (msg) {
                            ...
                            <ul class="k-group">
                                    ...
                                    <ul class="k-group" style="overflow: visible; display: none; height: 0px;">
                                        <li class="k-item" role="treeitem" data-uid="e81addf7-e873-48de-8efd-d2543fc43c3d"
                                            ...
                                            <ul class="k-group" style="height: 0px; overflow: visible; display: none;">
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_aranibtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Arani Cc &nbsp; <span
                                                                        ...
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_arani_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_arani_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_aranidept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                       <span onclick="get_walajabtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Walaja &nbsp; <span
                                                                        ...
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_Walaja_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_walaja_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_walajadept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_kpmbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    ...
                                                                    <span id="spn_kpm_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_kpm_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_kpm_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_kpmdept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_rcbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Rc Puram &nbsp; <span
                                                                        ...
                                                                        border-radius: 5px; font-size: 14px; position: relative; height: 26px; line-height: 21px;">₹ 00/-
                                                                    </span>&nbsp; <span id="spn_rc_Pers" style="background-color: rgb(68, 128, 226);
                                                                        color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                        height: 26px; line-height: 21px;">0.0% </span><span id="spn_rc_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_rcdept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                       <span onclick="get_taribtype_report();" class="k-icon k-i-expand"></span> <span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Tarigonda &nbsp; <span
                                                                        ...
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_tari_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_tari_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_taridept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_Kaligiribtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Kaligiri &nbsp; <span
                                                                        ...
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/- </span>&nbsp; <span id="spn_Kaligiri_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_Kaligiri_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_Kaligiridept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_rmrdbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    ...
                                                                    <span id="spn_rmrd_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/- </span>&nbsp; <span id="spn_rmrd_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_rmrd_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_rmrddept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                            </ul>
                                            <%--//-----------------------//--%>
                                        ...
                                        <li class="k-item" role="treeitem" data-uid="e81addf7-e873-48de-8efd-d2543fc43c3d"
                                            ...
                                            <ul class="k-group" style="height: 0px; overflow: visible; display: none;">
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_punabakabtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Punabaka &nbsp; <span
                                                                        ...
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_punabaka_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_punabaka_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_punabakadept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                 ...
                                                 <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_kuppambtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Kuppam &nbsp; <span
                                                                        ...
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_Kuppam_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_kuppam_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_kuppamdept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <ul class="k-group" style="height: 0px; overflow: visible; display: none;">
                                           <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_chennaibtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Chennai &nbsp; <span
                                                                        ...
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_chn_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_chn_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_chennaidept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_bangbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Kuppam &nbsp; <span
                                                                        id="spn_bang_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_bang_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_bang_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_bangdept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_kanchibtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>kanchi puram &nbsp; <span
                                                                        id="spn_kanchi_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_kanchi_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_kanchi_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_kanchidept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_nlrbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Nelloor &nbsp; <span
                                                                        ...
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_nlr_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_nlr_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_nlrdept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_mdnplbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Madanapally &nbsp; <span
                                                                        id="spn_mdnpl_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_mdnpl_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_mdnpl_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_mdnpldept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_tptbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Thirupathi &nbsp; <span
                                                                        ...
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_tpt_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_tpt_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_tptdept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_ccobtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Chennai corpo ofc &nbsp; <span
                                                                        id="spn_cco_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_cco_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_cco_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_ccodept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_skhtbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Skht Parlour &nbsp; <span
                                                                        id="spn_skht_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_skht_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_skht_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_skhtdept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_mdnplparlbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Madanapally Parlour &nbsp; <span
                                                                        id="spn_mdnplparl_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_mdnplparl_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_mdnplparl_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_mdnplparldept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
                                ...
                                <li class="k-item" role="treeitem" data-uid="d637e460-3d61-4ca2-9a48-1caa4b71ae77"
                                  ...
                                  <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_kvlbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Kavali Office &nbsp; <span
                                                                        id="spn_kvl_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_kvl_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_kvl_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_kvldept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                ...
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_kondepibtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Kondepi &nbsp; <span
                                                                        ...
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_Kondepi_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_kondepi_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_kondepidept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                ...
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_kvlpbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Kavali Plant &nbsp; <span
                                                                        id="spn_kvlp_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_kvlp_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_kvlp_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_kvlpdept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                ...
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_gudlurubtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Gudluru &nbsp; <span
                                                                        ...
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_gudluru_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_gudluru_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_gudlurudept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                ...
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_gdplbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Gudipalli Padu &nbsp; <span
                                                                        id="spn_gdpl_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_gdpl_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_gdpl_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_gdpldept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                                ...
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_csbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>C.S.Puram &nbsp; <span
                                                                        id="spn_cs_totsal" style="background-color: rgb(68, 128, 226); color: #fff;
                                                                        padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative; height: 26px;
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_cs_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_cs_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_csdept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                               </ul>
                                          </li>
                                        ...
                                        <li class="k-item" role="treeitem" data-uid="e81addf7-e873-48de-8efd-d2543fc43c3d"
                                            ...
                                            <ul class="k-group" style="height: 0px; overflow: visible; display: none;">
                                                <li class="k-item" role="treeitem" data-uid="f125c077-35fc-4778-a997-b5657c9c7967"
                                                    aria-selected="false">
                                                    <div class="k-top">
                                                        <span onclick="get_ramdevbtype_report();" class="k-icon k-i-expand"></span><span class="k-in">
                                                            <div class="k-top">
                                                                <span class="k-in"><span class="k-sprite folder"></span><span class="k-in" style="border: 1px solid;
                                                                    background: aliceblue;"><span class="k-sprite folder"></span>Kavali Office &nbsp; <span
                                                                        ...
                                                                        line-height: 21px;">₹ 00/-</span>&nbsp; <span id="spn_rmrdplant_Pers" style="background-color: rgb(68, 128, 226);
                                                                            color: #fff; padding: 4px 8px; border-radius: 5px; font-size: 14px; position: relative;
                                                                            height: 26px; line-height: 21px;">0.0% </span><span id="spn_rmrde_bid" style="display:none;"></span></span></span>
                                                            </div>
                                                        </span>
                                                    </div>
                                                    <ul style="height: 0px; overflow: visible;">
                                                            <div id="div_rmrdedept" style="padding-left: 25%;"></div>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
