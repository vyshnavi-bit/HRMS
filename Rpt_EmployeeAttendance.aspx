<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true"
    CodeFile="Rpt_EmployeeAttendance.aspx.cs" Inherits="Rpt_EmployeeAttendance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdateProgress ID="updateProgress1" runat="server">
        ...
        <section class="content-header">
            <h1>
                Employee Attendance Report<small>Preview</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content" style="overflow: inherit !important;">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <i style="padding-right: 5px;" class="fa fa-cog"></i>Employee Wise Attendance Details
                    </h3>
                </div>
                <div class="box-body">
                               ...
                               <table>
                                   ...
                                   <td>
                                    ...
                                    <asp:Label ID="Label3" runat="server" Text="Label">EmployeeType</asp:Label>&nbsp;
                                            <asp:DropDownList ID="ddl_Emptype" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddl_Emptype_SelectedIndexChanged"  CssClass="form-control">
                                            </asp:DropDownList>
                                   </td>
                                   <td>
                                   <asp:Label ID="Label2" runat="server" Text="Label">Employee</asp:Label>&nbsp;
                                            <asp:DropDownList ID="ddl_EmpId" runat="server"   CssClass="form-control">
                                            </asp:DropDownList>
                                   </td>
                                       <td style="width: 6px;">
                                       </td>
                                       ...
                                       <td>
                                           <asp:Button ID="btn_Generate" runat="server" Text="GENERATE" CssClass="btn btn-success"
                               ...
                               <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                                   ...
                                   <div style="width:100%;">
                                     ...
                                     <table style="width: 80%">
                                       ...
                                       <div>
                                           <asp:GridView ID="dg_EmployeeAttendance" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
