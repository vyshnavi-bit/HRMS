<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="MonthlyWorkingDays.aspx.cs" Inherits="MonthlyWorkingDays" %>
 ...
 <style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function fillbranchdetails(msg) {
            ...
            $(tablestrctr).append('<thead><tr><th>Sno</th><th><i class="fa fa-user" style="font-size:20px;padding-right: 5px;"></i>Branch Name</th><th>Number of working Days</th></tr></thead><tbody></tbody>');
            for (var i = 0; i < gradestudentsdata.length; i++) {
                ...
                var j = 0;
                j = i + 1;
                $(tablestrctr).append('<tr><td>' + j + '</td><td class="1">' + gradestudentsdata[i].branchname + '</td><input id="hdnempsno" type="hidden" value="' + gradestudentsdata[i].branchid + '" /></td></td><td><input type="text" style="border:2px solid green;border-radius:4px;" id="txt_Numberofworkingdays" value=""/></tr>');
            }
        ...
        function btn_cancelApply_click() {
            ...
            document.getElementById('txt_Numberofworkingdays').value = " ";
        }
        function btn_Finalize_Attendence() {
            ...
            $(rows).each(function (i, obj) {
                var branchid = $(this).find('#hdnempsno').val();
                var numberofworkingdays = $(this).find('#txt_Numberofworkingdays').val();
                studentslist.push({ 'branch': branchid, 'numberofworkingdays': numberofworkingdays });
                //studentslist.push(abc);
            });
            var month = $("#select_mnth option:selected").val();
            var year = $("#select_year option:selected").val();
            var Data = { 'op': 'save_Monthlyworkingdays', 'employeeslist': studentslist, 'month': month, 'year': year };
            var s = function (msg) {
                if (msg && msg != 'false') {
                    alert(msg);
                    //btn_Students_click();
...
<section class="content-header">
        <h1>
            Monthly WorkingDays<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Monthly WorkingDays Management</a></li>
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Monthly WorkingDays
                </h3>
            </div>
