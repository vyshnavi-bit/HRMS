...
public partial class SAPSalaryReport : System.Web.UI.Page
{
    SqlCommand cmd;
    string userid = "";
    DBManager vdm;
    ...
    protected void btn_Generate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            lblHeading.Text = ddlbranches.SelectedItem.Text + " SAP Salary Statement" + ddlmonth.SelectedItem.Text + year;
            ...
            string invoice = "" + ddlemptype.SelectedItem.Text + "" + invoivebranch + "JV" + mymonth + "";
            ...
            if (ddlemptype.SelectedItem.Text == "Staff" || ddlemptype.SelectedItem.Text == "Permanent")
            {
               ...
               // Report.Columns.Add("Name");
                ...
                cmd = new SqlCommand("SELECT employedetails.employee_num, employedetails.fullname, employedetails.empid, tds_deduction.tdsamount FROM employedetails INNER JOIN tds_deduction ON employedetails.empid = tds_deduction.empid WHERE (employedetails.branchid = @branchid) AND (employedetails.company_id IS NULL)");
            ...
            foreach (DataRow dreport in Report.Select("DESIGNATION='" + designation + "'"))
            {
                ...
                else
                {
                    ...
                    string mledger = medicl_lger;
                    mledger = mledger.Substring(0, 3);
