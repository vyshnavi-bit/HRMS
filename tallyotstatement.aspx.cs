...
public partial class tallyotstatement : System.Web.UI.Page
{
    SqlCommand cmd;
    string BranchID = "";
    DBManager vdm;
    ...
    protected void btn_Generate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            lblHeading.Text = ddlbranches.SelectedItem.Text + " Tally OT Statement Report" + " " + ddlmonth.SelectedItem.Text + year;
            lblFromDate.Text = mymonth;
            DateTime dtfrom = fromdate;
            string frmdate = dtfrom.ToString("dd/MM/yyyy");
            string[] str = frmdate.Split('/');
            Session["xporttype"] = "TallyOTSalarys";
            Session["filename"] = ddlbranches.SelectedItem.Text + " Tally OT Statement " + " " + ddlmonth.SelectedItem.Text + year;
            Session["title"] = ddlbranches.SelectedItem.Text + " Tally OT Statement " + " " + ddlmonth.SelectedItem.Text + year;
            ...
            if (dtAdvance.Rows.Count > 0)
            {
                ...
                string amount =  amt + "";
                nr_sp["Amount"] = amount;
                narration = "Being The SVDS " + ddlbranches.SelectedItem.Text + " OT For the Month Of " + namonth + ", Total Amount=" + amt + "/-";
               ...
               // nd_sp["Ledger Name"] = "Salary OT Payble - " + ddlbranches.SelectedItem.Text + "";
                ...
                nd_sp["Amount"] = "-" + damt;
                narration = "Being The SVDS " + ddlbranches.SelectedItem.Text + " OT For the Month Of " + namonth + ", Total Amount=" + damt + "/-";
