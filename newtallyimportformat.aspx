<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="newtallyimportformat.aspx.cs" Inherits="newtallyimportformat" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Tally Salary Statement<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Tally Salary Report</a></li>
                </ol>
            </section>
            <section class="content" style="min-height:400px;">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Tally Salary Statement Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
